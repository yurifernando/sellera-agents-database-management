...
DELETE FROM `sellera-data-prod.data_agents.strategy_products_types` WHERE TRUE;
...
DELETE FROM `sellera-data-prod.data_agents.commercial_operation_strategy_products` WHERE TRUE;
